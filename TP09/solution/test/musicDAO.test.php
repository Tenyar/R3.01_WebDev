...
// Test la valeur min
$value = $jukebox->minId(); $expected = 1;assert( $value === $expected,"Le min des id doit être $expected (trouvé $value)\n");
...
// Test la valeur max
$value = $jukebox->maxId(); $expected = 554;assert( $value === $expected,"Le max des id doit être $expected (trouvé $value)\n");
